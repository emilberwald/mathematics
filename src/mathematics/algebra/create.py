...
def multilinear_mapping_as_tensor(cls, vector_base_to_dual_base,
	*vector_bases):
	r"""
...
def mixed_tensor(cls, vector_base, order, vector_base_to_dual_base):
	...
	return multilinear_mapping_as_tensor(cls, vector_base_to_dual_base,
...
def kronecker_delta_tensor(cls, vector_base, vector_base_to_dual_base):
	...
	"""
	return mixed_tensor(cls, vector_base, vector_base_to_dual_base,
...
def same_coefficient_tensor(cls, coefficient, vector_base, rank,
	vector_base_to_dual_base):
	return mixed_tensor(cls, vector_base, rank,
